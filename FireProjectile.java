...
public class FireProjectile extends Projectile {
    ...
    private final ICMazeInteractionVisitor handler = new FireProjectileInteractionHandler();

    public FireProjectile(Area area, Orientation orientation, DiscreteCoordinates position) {
        super(area, orientation, position);
        this.animation = new Animation("icmaze/magicFireProjectile", 4, 1f, 1f, this, 32, 32,
